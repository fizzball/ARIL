...
- Generated chat images: **Copy image** and **Save…** (also via right-click)
...
- **Adaptive routing (Auto / Manual / Compare)**
  ...
  - **Manual** — Locks the model you chose (no auto swapping); shortlist + searchable Other… catalog with category filters.
...
- **Generated image actions** — Copy or save images produced in chat.
