...
- Manual mode model menu: searchable **Other…** from the full OpenRouter catalog
- New catalog picks are pinned to the top of the shortlist (max 8)
- Other… browser: filter by Coding, Security, Reasoning, Vision, Cost, Performance, Confidence, General
...
- **Adaptive routing (Auto / Manual / Compare)**
  ...
  - **Manual** — Locks the model you chose (no auto swapping); shortlist + searchable Other… catalog.
