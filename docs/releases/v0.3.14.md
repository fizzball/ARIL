...
- Optional menu bar icon while ARIL is running (Preferences → General)
- Native themed Preferences window
- Clearer gateway errors and OpenRouter key validation
...
> First launch may show a Gatekeeper prompt for unsigned/ad-hoc builds. Right-click **ARIL → Open** if macOS blocks the app.
